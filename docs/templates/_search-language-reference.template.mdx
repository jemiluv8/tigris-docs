...
- `SelectorFilterOperator.EQ` - Matches documents where the field value is equal to the provided value.
- `SelectorFilterOperator.LT` - Matches documents where the field value is less than the provided value.
- `SelectorFilterOperator.LTE` - Matches documents where the field value is less than or equal to the provided value.
- `SelectorFilterOperator.GT` - Matches documents where the field value is greater than the provided value.
- `SelectorFilterOperator.GTE` - Matches documents where the field value is greater than or equal to the provided value.

- `LogicalOperator.AND` - Matches documents where all of the provided filters match.
- `LogicalOperator.OR` - Matches documents where at least one of the provided filters match.
