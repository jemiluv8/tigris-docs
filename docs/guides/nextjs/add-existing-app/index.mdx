...
If you are interested in how to easily create a new Next.js application with Tigris, check out
the [How to create a new Next.js project with Tigris using create-next-app](https://www.tigrisdata.com/blog/create-next-app-with-tigris/) blog.
