...
This guide demonstrates two approaches to deploying an existing Next.js + Tigris application to [Vercel](https://vercel.com).
...
And that's it. You have successfully deployed your Next.js + Tigris application to Vercel.
Head over to the [How to create a new Next.js project with Tigris using create-next-app](https://www.tigrisdata.com/blog/create-next-app-with-tigris/)
