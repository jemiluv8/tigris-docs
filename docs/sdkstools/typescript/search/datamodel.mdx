...
[Decorated classes](#declare-using-decorators) or [Interfaces](#declare-using-interface).
...
<TSDataModels
  decoratorExample={embeddedWithDecorator}
  interfaceExample={embeddedWithInterface}
/>
