...
This is why we have built Tigris. Tigris is a serverless NoSQL database and
search platform that provides a suite of data services with an API-like approach
to interact with data just as apps interact with other services such as Stripe.
This allows you to build rich data-driven applications in an infrastructure-less
way.
