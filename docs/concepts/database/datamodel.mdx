...
- [Data modeling in TypeScript](../../sdkstools/typescript/database/datamodel.mdx)
- [Data modeling in Go](../../sdkstools/golang/database/datamodel.mdx)
- [Data modeling in Java](../../sdkstools/java/database/datamodel/declare.md)
