...
| **Search**      | Documents in collections are searchable in real-time. Search operations, similar to what are provided by standalone search platforms such as Elasticsearch and Pinecone, are supported out of the box. See the [Vector Search](../../vector-search) and [Full-text Search](../../searching) sections to learn more.                                                                                                                               |
